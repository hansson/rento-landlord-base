...
<html lang="sv">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="row">
          <div class="col-md-12">
            <h3>Inflytt</h3>
            <textarea id="move_in-info" name="info" class="std-textarea"></textarea>
    ...
    <script>
      ...
      $.get('../api/info.php?move_in=1',function(data){
        nicEditors.findEditor("move_in-info").setContent(data);
      });
      ...
      $(document).ready(function() {
        $('#submit-info').on('click', function(event){
          $.post('../api/info.php','move_in=' + nicEditors.findEditor("move_in-info").getContent(), function(data, status) {
              $('.alert').show();
          });
        });
